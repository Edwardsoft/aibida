  ...
  <div class="row col-sm-12">
    ...
    <div class="col-sm-10">
      <div class="row col-sm-12" style="border-bottom:1px solid #e4e4e4;padding:10px;font-size:20px;">
        <div class="col-sm-4">
        <a href="Search?content=${content }"">捐赠</a>/志愿服务
        </div>       
      </div>
      <div class="col-sm-12 row" id="donate_search">
        <div class="col-sm-12 row">
          搜索<span style="color:orange;">"${content}"</span>，找到${volunteer_project_size}个志愿项目 
        </div>
        <c:forEach items="${volunteer_projects}" var="volunteer_project">
          <div class="col-sm-12 row" style="padding:10px;">
            <div class="col-sm-2">
              <a href="Volunteer_show?project_id=${volunteer_project.id}"><img src="${volunteer_project.img}" style="width: 100%;"></a>
            </div>
            <div class="col-sm-4" style="font-size: 18px;">
              <a href="Volunteer_show?project_id=${volunteer_project.id}">
