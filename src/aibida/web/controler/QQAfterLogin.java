...
/**
 * Servlet implementation class QQAfterLogin
 */
@WebServlet("/afterlogin.do")
public class QQAfterLogin extends HttpServlet {
        ...
        try {
            ...
            if (accessTokenObj.getAccessToken().equals("")) {
                ...
                if (userInfoBean.getRet() == 0) {
                    ...
                    User user=iuser.addQQUser(openID, userInfoBean.getNickname(), userInfoBean.getAvatar().getAvatarURL30());
                    request.getSession().setAttribute("user", user);
                    response.sendRedirect("index.jsp");
                    out.println(user.getUserName()+"   我获取的昵称");
                } else {
